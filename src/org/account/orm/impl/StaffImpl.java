...
public class StaffImpl  {
	...
	public List<Staff> findHoldList(){
	...
	public Staff findHoldByNumber(String number) {
		Object[] ret = (Object[])HibernateUtil.queryOnly("FROM  Staff s, Account a WHERE  s.number='"+number+"' and s.account.id=a.id");
		return ret == null ? null: (Staff)ret[0];
	}
