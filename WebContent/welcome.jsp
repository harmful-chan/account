        ...
        <div class="card "> 
         ...
         <div class="card-body "> 
          <div class="row"> 
           ...
           <div class="col-md-4 ">
            <img class="img-responsive" alt="Responsive image" src="../images/lock_2.png" />
           </div> 
           <div class="col-md-4 "></div> 
          </div> 
          <br /> 
          ...
          <form"> 
           ...
           <div class="form-group"> 
            ...
            <div class="form-group"> 
             ...
             <input type="password" class="form-control" id="form_password" value="<%=home.getDeeppwd() %>" disabled=""/> 
            </div> 
            <div class="checkbox"> 
             <label> <input type="checkbox" /> 记住密码 </label> 
            </div> 
            <button class="btn btn-default"">已登录</button>  
           </div>
          </form> 
