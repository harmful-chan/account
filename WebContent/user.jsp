...
<%@  page import="org.account.web.bean.UserContext,java.util.*, org.account.orm.bean.*" %>
<%
	...
	UserContext user = (UserContext)session.getAttribute("user_info");
	String user_update_url = (String)session.getAttribute("user_update_url");
%>
<html>
<head>
    <meta charset="utf-8" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 pr-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" readonly unselectable="on" placeholder="Company"
                                                name="company" value="<%=user.getCompany() %>" />
                                            </div>
                                        </div>
                                        <div class="col-md-4 px-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" readonly unselectable="on" placeholder="Account"
                                                name="accountNumber" value="<%=user.getAccountNumber()%>" />
                                            </div>
                                        </div>
                                        <div class="col-md-4 pl-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" readonly unselectable="on" placeholder="Operator"
                                                name="operator" value="<%=user.getOperator() %>" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" readonly unselectable="on" placeholder="Department"
                                                name="department" value="<%=user.getDepartment() %>" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" readonly unselectable="on" placeholder="Position"
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" readonly unselectable="on" placeholder="Permission"
                                                name="permission" value="<%=user.getPermissioms() %>" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Entry Date" name="entryDate"
                                                value="<%=user.getEntryDate() %>" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                            ...
                            <div class="card-body">
                                <div class="author">
                                    <a href="#">
                                        ...
                                        <h5 class="title"><%=user.getFirstName() %></h5>
                                    </a>
