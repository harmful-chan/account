            ...
            <div class="sidebar-wrapper">
                ...
                <ul class="nav">
                    <li class="nav-item active active-pro">
                        <a class="nav-link active"> <i class="nc-icon nc-alien-33"></i> 
                            <p>Upgrade to PRO</p>
                        </a>
                    </li>
                </ul>
                        ...
                        <ul class="nav navbar-nav mr-auto">
                            <li class="dropdown nav-item">
                                <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown"> 
									...
									<span class="notification"><%=test_hold_staffs.size() %></span>  
                                ...
                                <div class="card-body ">
                                    <form action="<%=login_url %>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <button type="submit" class="btn btn-info btn-fill pull-right" onclick="login()">登录</button>
...
<script>
	function login(){
		...
		document.getElementById("form_password").value = encode(password);
